...
class BaselineModel(nn.Module):
    def __init__(self, linear_size=1024, num_stages=2, p_dropout=0.5, predict_14=False, num_joints=16):
        """
        ...
        input_size = num_joints * 2  # Input 2d-joints.
        output_size = num_joints * 3 # if predict_14 else 16 * 3  # Output 3d-joints.
