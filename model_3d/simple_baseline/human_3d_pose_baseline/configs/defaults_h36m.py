...
# Input data.
_C.DATA = CN()
_C.DATA.HM36M_DIR = "dataset/h36m_3d"
...
_C.DATA.DATA = 'hm36m'  # 'hm36m' or 'panoptic'
...
_C.MODEL.PREDICT_17 = True
_C.MODEL.PREDICT_15 = True
_C.MODEL.WEIGHT = "weights/model_best_h36m.pth" # "output_panoptic/model_best.pth"
