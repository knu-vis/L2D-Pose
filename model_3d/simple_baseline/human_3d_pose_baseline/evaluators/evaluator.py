...
from ..utils import data_utils, procrustes, data_utils_panoptic, data_utils_h36m


class Human36M_JointErrorEvaluator:
    def __init__(self, human36m, predict_17=True, apply_procrustes_alignment=False):
        """
    ...
    def get_metrics(self):
        ...
        for action in data_utils_h36m.H36M_ACTIONS:
            mask = actions == action
    ...
    def _preprocess_poses(self, poses_3d):
        ...
        poses = data_utils_h36m.unnormalize_data(
...
class PANOPTIC_JointErrorEvaluator:
    def __init__(self, panoptic, apply_procrustes_alignment=False):
        """
    ...
    def _preprocess_poses(self, poses_3d):
        mean_3d = self.panoptic.mean_3d
        std_3d = self.panoptic.std_3d
        dim_to_ignore_3d = self.panoptic.dim_to_ignore_3d
        dim_to_use_3d = self.panoptic.dim_to_use_3d

        # Unnormalize 3d poses.
        poses = data_utils_panoptic.unnormalize_data(
            poses_3d, mean_3d, std_3d, dim_to_ignore_3d
        )  # [batch_size, 32 x 3]
