...
from common.generator_panoptic import ChunkedGenerator
...
class Fusion(data.Dataset):
    def __init__(self, opt, train=True):
        ...
        self.pad = opt.pad # 0
        self.joints_left, self.joints_right = list(panoptic_skeleton.joints_left()), list(panoptic_skeleton.joints_right())
        self.kps_left, self.kps_right = list(panoptic_skeleton.joints_left()), list(panoptic_skeleton.joints_right())
        if self.train:
            ...
            self.cameras_train, self.poses_train, self.poses_train_2d = load_data(TRAIN_LIST)
            ...
            self.cameras_test, self.poses_test, self.poses_test_2d = load_data(VALID_LIST)
