...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--checkpoint', type=str, default='iganet_panoptic')
        ...
        self.parser.add_argument('--out_joints', type=int, default=15)
    ...
    def parse(self):
        ...
        if self.opt.dataset == 'h36m':
            ...
            if self.opt.keypoints.startswith('sh') or self.opt.keypoints.startswith('hr'):
                ...
                self.opt.n_joints = 15
                self.opt.out_joints = 15

                self.opt.joints_left = [3, 4, 5, 6, 7, 8] 
                self.opt.joints_right = [9, 10, 11, 12, 13, 14]
