...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--batch_size', type=int, default=1024, help='can be changed depending on your machine') # default 128
        ...
        self.parser.add_argument('--checkpoint', type=str, default='iganet_h36m')
