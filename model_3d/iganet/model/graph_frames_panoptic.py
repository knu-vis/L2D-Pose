...
class Graph():
    ...
    def get_distance_to_center(self, layout): 
        ...
        # elif layout == 'panoptic':
        for i in range(self.seqlen):
            index_start = i*self.num_node_each
            dist_center[index_start+0 : index_start+7] = [1, 2, 0, 2, 3, 4, 1]
            dist_center[index_start+7 : index_start+11] = [2, 3, 2, 3]
            dist_center[index_start+11 : index_start+15] = [4, 1, 2, 3]
    ...
    def get_edge(self, layout):
        ...
        #     self.center = 8 - 1
        # elif layout == 'panoptic':
        self.num_node_each = 15

        neighbour_base = [(2, 12), (13, 12), (14, 13), (6, 2), (7, 6), (8, 7), 
                            (0, 2), (1, 0), (3, 0), 
                            (4, 3), (5, 4), (9, 0), (10, 9), (11, 10)
                            ]
                    
        sym_base = [(8, 14), (7, 13), (6, 12), (3, 9), (4, 10), (5, 11)]  

        self_link, time_link = self.basic_layout(neighbour_base, sym_base) # self_link: node itself; time_link: 

        self.la, self.ra =[3, 4, 5], [9, 10, 11] # left and right arm
        self.ll, self.rl = [6, 7, 8], [12, 13, 14] # left and right leg
        self.cb = [2, 0, 1] # center bone
        self.part = [self.la, self.ra, self.ll, self.rl, self.cb]
