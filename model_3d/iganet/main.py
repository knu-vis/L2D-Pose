...
from common.arguments_h36m import opts as parse_args
...
if __name__ == '__main__':
    ...
    if args.create_file:
        ...
        shutil.copyfile(src="common/arguments_h36m.py", dst = os.path.join(args.checkpoint, args.create_time + "_arguments_h36m.py"))
        shutil.copyfile(src="model/model_IGANet_h36m.py", dst = os.path.join(args.checkpoint, args.create_time + "_model_IGANet_h36m.py"))
